...
def create_straight_segment(previous_pose: Pose3F64, next_frame_b: str, distance: float) -> Pose3F64:
    ...
    Returns:
        Pose3F64: The next pose.
    """
    straight_segment: Pose3F64 = Pose3F64(
        a_from_b=Isometry3F64([distance, 0, 0], Rotation3F64.Rz(0)), frame_a=previous_pose.frame_b, frame_b=next_frame_b
    )
    return previous_pose * straight_segment


def create_turn_segment(previous_pose: Pose3F64, next_frame_b: str, angle: float) -> Pose3F64:
